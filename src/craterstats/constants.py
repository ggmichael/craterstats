...
cst.ABOUT =["*Craterstats-III",
            "Copyright (c) 2021-2026, Greg Michael",
            "Licensed under BSD 3-Clause License. See LICENSE.txt for details.",
            ...
            "Standard techniques for presentation and analysis of crater size–frequency data. Icarus 37, 1979. doi:10.1016/0019-1035(79)90009-5",
            "",
            "*Formulation of a planetary surface chronology model",
            "Neukum G., Meteorite bombardment and dating of planetary surfaces (English translation, 1984). Meteoritenbombardement und Datierung planetarer Oberflächen (German original, 1983). url:http://ntrs.nasa.gov/search.jsp?R=19840027189",
            "",
            "*Resurfacing correction for cumulative fits; production function differential forms",
            "Michael G.G., Neukum G., Planetary surface dating from crater size-frequency distribution measurements: Partial resurfacing events and statistical age uncertainty. EPSL 294, 2010. doi:10.1016/j.epsl.2009.12.041",
            "",
            "*Differential fitting; binning bias correction; revised Mars epoch boundaries",
            "Michael G.G., Planetary surface dating from crater size-frequency distribution measurements: Multiple resurfacing episodes and differential isochron fitting. Icarus, 2013. doi:10.1016/j.Icarus.2013.07.004",
            "",
            "*Buffered crater counts",
            "Kneissl T., Michael G.G., Platz T., Walter S., Age determination of linear surface features using the Buffered Crater Counting approach – Case studies of the Sirenum and Fortuna Fossae graben systems on Mars. Icarus, 2015. doi:10.1016/j.icarus.2014.12.008",
            "",
            "*Poisson timing analysis; mu-notation",
            "Michael G.G., Kneissl T., Neesemann A., Planetary surface dating from crater size-frequency distribution measurements: Poisson timing analysis. Icarus, 2016. doi:10.1016/j.Icarus.2016.05.019",
            "",
            ...
            "region of planned Chang’E-5 landing Poisson age-likelihood calculation for a buffered crater counting area. EPSL 568, 2021. doi:10.1016/j.epsl.2021.117031",
            "",
            "*Small-area and low number counts: age-area-uncertainty plots",
            "Michael G., Liu J., Planetary surface dating from crater size–frequency distribution measurements: interpretation of small-area and low number counts. Icarus 431, 2025. doi:10.1016/j.icarus.2025.116489",
            "",
            "*Sequence probability and simultaneous formation",
            "Michael G., Zhang L., Wu C., Liu J., Planetary surface dating from crater size–frequency distribution measurements: Sequence probability and simultaneous formation. Did the close Chang’E-6 mare units form simultaneously? Icarus 438, 2025. doi:10.1016/j.icarus.2025.116644",
            "",
            "Full references for chronology or equilibrium functions are listed with the function definitions in `config/functions.txt`.",
            "",
            ]
